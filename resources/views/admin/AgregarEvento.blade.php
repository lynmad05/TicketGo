...
@section('contenido')
    <div class="w-full max-w-7x1 mx-auto bg-white p-10 mt-10 rounded shadow border">
        <h2 class="text-2xl font-bold mb-8 text-black text-center">Registrar Evento</h2>

        <div class="flex justify-end mb-6">
            <a href="{{ route('admin.eventos.index') }}"
                class="bg-blue-700 hover:bg-blue-800 text-white px-6 py-2 rounded font-semibold shadow transition">
                Lista de Eventos
            </a>
        </div>
        ...
        <form action="{{ route('admin.eventos.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <select id="categoria" name="categoria" required
                        class="w-full border rounded px-3 py-2 bg-white focus:outline-none focus:ring-1 focus:ring-black">
            ...
            <div class="mb-6">
                ...
                <textarea id="descripcion" name="descripcion" rows="3" placeholder="Escribir aquí..." required
                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-black"></textarea>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <!-- Fecha y hora -->
                <div>
            ...
            <div class="mb-8">
                ...
                <div
                    class="border-2 border-dashed rounded-lg p-8 flex flex-col items-center justify-center bg-yellow-50 mb-4">
                ...
                <div class="border-2 border-dashed rounded-lg p-8 flex flex-col items-center justify-center bg-yellow-50">
                    <svg class="w-12 h-12 text-yellow-400 mb-2" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 16v-8m0 0l-4 4m4-4l4 4M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2"></path>
            ...
            <div class="flex justify-center gap-8">
                <button type="submit"
                    class="bg-blue-700 text-white px-8 py-2 rounded font-semibold hover:bg-blue-800 transition">Guardar</button>
                <button type="reset"
                    class="bg-yellow-400 text-black px-8 py-2 rounded font-semibold hover:bg-yellow-500 transition">Limpiar</button>
            </div>
        </form>
    </div>
@endsection
