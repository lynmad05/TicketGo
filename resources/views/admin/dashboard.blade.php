...
@section('contenido')
    ...
    <div class="w-full bg-white px-6 py-8 shadow-md flex flex-col md:flex-row items-center gap-6">
        <!-- Texto -->
        <div class="md:w-1/2">
            <h1 class="text-2xl font-bold text-yellow-500">¡Bienvenido, Administrador!</h1>
    ...
    <div class="w-full bg-gray-400 px-6 py-10">
        ...
        <div class="flex justify-center gap-12 mt-10 w-full max-w-4xl mx-auto">
            ...
            <div class="flex flex-col items-center">
                <div class="bg-yellow-500 rounded-full w-24 h-24 flex items-center justify-center">
                    <div class="w-16 h-16 flex items-center justify-center">
                        <img src="{{ asset('images/eventopublicado.png') }}" alt="Icono 1"
            ...
            <div class="flex flex-col items-center">
                <div class="bg-yellow-500 rounded-full w-24 h-24 flex items-center justify-center">
                    <div class="w-16 h-16 flex items-center justify-center">
                        <img src="{{ asset('images/eticketemitido.png') }}" alt="Icono 2"
                            class="max-w-full max-h-full object-contain">
                    </div>
                </div>
            ...
            <div class="flex flex-col items-center">
                <div class="bg-yellow-500 rounded-full w-24 h-24 flex items-center justify-center">
                    <div class="w-16 h-16 flex items-center justify-center">
                        <img src="{{ asset('images/clientes.png') }}" alt="Icono 3"
                            class="max-w-full max-h-full object-contain">
                    </div>
                </div>
            ...
            <div class="flex flex-col items-center">
                <div class="bg-yellow-500 rounded-full w-24 h-24 flex items-center justify-center">
                    <div class="w-16 h-16 flex items-center justify-center">
                        <img src="{{ asset('images/artistas.png') }}" alt="Icono 4"
                            class="max-w-full max-h-full object-contain">
                    </div>
                </div>
