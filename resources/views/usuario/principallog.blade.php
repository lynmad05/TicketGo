...
<div class="container px-6 mx-auto">
    <section  class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
        ...
        <article class="border border-gray-300 rounded-lg overflow-hidden shadow-sm transition transform duration-200 hover:scale-[1.02] hover:shadow-lg"  data-img="{{ asset('images/Eventodeyvis.jpg') }}">
        ...
        <article class="border border-gray-300 rounded-lg overflow-hidden shadow-sm transition transform duration-200 hover:scale-[1.02] hover:shadow-lg"  data-img="{{ asset('images/alvaro.jpg') }}">
        ...
        <article class="border border-gray-300 rounded-lg overflow-hidden shadow-sm transition transform duration-200 hover:scale-[1.02] hover:shadow-lg"  data-img="{{ asset('images/Eventohablando.jpg') }}">
        ...
        <article class="border border-gray-300 rounded-lg overflow-hidden shadow-sm transition transform duration-200 hover:scale-[1.02] hover:shadow-lg"  data-img="{{ asset('images/Eventotrueno.jpg') }}">
        ...
        <article class="border border-gray-300 rounded-lg overflow-hidden shadow-sm transition transform duration-200 hover:scale-[1.02] hover:shadow-lg" data-img="{{ asset('images/Eventoemilia.jpg') }}">
