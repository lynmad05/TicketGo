...
{{-- Contenedor principal: columna con arriba izquierda (documento+medio pago) y derecha (aside), luego resumen abajo --}}
<div class="max-w-6xl mx-auto space-y-8">
  ...
  <div class="flex flex-col md:flex-row md:space-x-10">
    ...
    {{-- Derecha: Aside derecho con info del evento y botón --}}
