...
<body class="bg-gray-100">
    ...
    <nav class="bg-white shadow-md py-4 px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
        <a href="#" class="w-full max-w-[220px] mx-auto bg-yellow-500 text-black px-4 py-2 rounded flex items-center gap-2 justify-center hover:bg-yellow-600 transition">
        ...
        <a href="{{ route('admin.promociones.index') }}" class="w-full max-w-[220px] mx-auto bg-yellow-500 text-black px-4 py-2 rounded flex items-center gap-2 justify-center hover:bg-yellow-600 transition">
            <i class="fa-solid fa-tags text-black"></i> Registrar Promociones
        </a>
        <a href="{{ route('admin.proveedores.index') }}" class="w-full max-w-[220px] mx-auto bg-yellow-500 text-black px-4 py-2 rounded flex items-center gap-2 justify-center hover:bg-yellow-600 transition">
